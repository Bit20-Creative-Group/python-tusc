...
class Operation(GrapheneOperation):
    """Need to overwrite a few attributes to load proper operations from tusc."""

    module = "tuscbase.operations"
    operations = operations


class ObjectId(GPHObjectId):
    """Need to overwrite a few attributes to load proper object_types from tusc."""
