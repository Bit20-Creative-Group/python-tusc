...
from tuscapi.websocket import BitSharesWebsocket
...
class Notify(Events, BlockchainInstance):
    ...
    :param list markets: Instances of :class:`tusc.market.Market` that identify markets to be monitored
    ...
    **Example**
    ...
    .. code-block:: python
        ...
        from tusc.notify import Notify
        from tusc.market import Market
    ...
    def process_market(self, data):
        ...
        * :class:`tusc.price.Order` or
        * :class:`tusc.price.FilledOrder` or
        * :class:`tusc.price.UpdateCallOrder`
    ...
    def process_account(self, message):
        ...
        :class:tusc.account.AccountUpdate`
        """
